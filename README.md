...
| `hob_mt.py` | HOB↔MT: Willow/PABT Transit stops; subway catchable after **LincTnl +3** (E @ PABT), **F +9** (wkdys 6a–9:30p), **7/S +6**, Grand Central from earlier **7|S +3**; **50 St** current **A/C**; **51/33 St** current ETAs; NY Waterway + MTA +15; side-by-side section layouts; PABT dep gate annotation |
